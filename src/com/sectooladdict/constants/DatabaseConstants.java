...
/**
 * This class contains constants used for database related activities.
 *
 * <p>The class contains various non-secure fields that are used for the purpose of testing web
 * application scanners, and therefore, most of the fields in this class are NOT suitable for
...
public final class DatabaseConstants {
     ...
     * @since 1.0
     */
    public static final String DATABASE_NAME = "wavsepDB";
     ...
     * @since 1.1.0
     */
    public static final String DERBY_CONNECTION_STRING = "jdbc:derby:" + DERBY_DATABASE_NAME + ";";
