...
/**
 * This class contains constants used for file prefix/suffix concatenation related activities.
 *
 * @author Shay Chen
 * @since 1.2
 */
public class FileConstants {
    ...
    /**
     * This constant is used for HTTP protocol enforcement. Designed to be used with the URL class.
     *
     * @since 1.2
     */
    ...
    /**
     * This constant is used for FTP protocol enforcement. Designed to be used with the URL class.
     *
     * @since 1.2
     */
    ...
    /**
     * This constant is used for FTP protocol port enforcement. Designed to be used with the URL
     * class.
     *
     * @since 1.2
     */
    ...
    /**
     * This constant is used for file directive enforcement. Designed to be used with the
     * File/FileInputStream class. Using only a single slash enables using the prefix with path that
     * begin with or without a slash (both file:/ and file:// are valid)
     *
     * @since 1.2
     */
    public static final String FILE_PREFIX = "file:"; // add / for Windows?
    ...
    /**
     * This constant is used to store the default target filename, when the default location is not
    ...
    /**
     * This constant is used to store the default invalid target destination for Unvalidated
